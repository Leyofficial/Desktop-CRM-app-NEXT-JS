...
export function CustomersCounter({title , numberOfPeople} : PropCounter){
    ...
    return (
        <div className={`relative border border-b-emerald-50-50 rounded-md p-8 flex-col justify-start items-start inline-flex`}>
            ...
            <div className={`${!isActive ? "bg-gradient-to-r from-7E92A2 to-white text-slate-400" : 'bg-gradient-to-b from-emerald-300 to-white text-green-500'} w-20 h-20 p-6 rounded-[100px] justify-center items-center inline-flex`}>
                <div className="grow shrink basis-0 self-stretch pl-[2.61px] pr-[2.67px] py-[2.67px] justify-center items-center inline-flex" >
                    <HiMiniUsers  fontSize={'2.5rem'}/>
                </div>
            </div>
            </div>
        </div>
